...
const initValidator = require('../../validate/init');
...
usernamePromptGenerator.addProperty('validate', initValidator.getLengthValidator('Please enter your username'));
...
passwordPromptGenerator.addProperty('validate', initValidator.getLengthValidator('Please enter your password'));
